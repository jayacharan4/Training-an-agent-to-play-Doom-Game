...
class DRQN():
    def __init__(self, input_shape, num_actions, initial_learning_rate):
        ...
        # deining the shape of our input, which would be (length, width, channels)
        self.input_shape = input_shape 
        
        # defining the number of actions in the environment
        self.num_actions = num_actions
        
        # defining the learning rate for the neural network
        self.learning_rate = initial_learning_rate
                
        # defining the hyperparameters of the convolutional neural network 
        ...
        # setting up the stride size
        self.stride = 2
        
        # setting up the pool size
        self.poolsize = 2 
        
        # setting up the shape of our convolutional layer
        ...
        #defining the hyperparameters of our recurrent neural network and the final feed forward layer
        
        # defining the number of neurons 
        self.cell_size = 100
        
        # setting up the number of hidden layers
        self.hidden_layer = 50
        
        # drop out probability
        self.dropout_probability = [0.3, 0.2]

        # setting up the hyperparameters for optimization
        self.loss_decay_rate = 0.96
        self.loss_decay_steps = 180

        
        # initializing all the variables for the CNN

        # initializing the placeholder for input whose shape would be (length, width, channel)
        ...
        # initializing the feature maps for our corresponding 3 filters
        ...
        # initializing the variables for RNN
        ...
        # initializing the weights and bias of feed forward network
        ...
        # now we build the RNN, which takes the input from the last layer of the convolutional network
        ...
        # we use the Adam optimizer for minimizing the error
        self.optimizer = tf.train.AdamOptimizer(self.learning_rate)
        
        # computing the gradients of the loss and update the gradients
...
class ExperienceReplay():
    ...
    # we remove the old transition if the buffer size has reached it's limit. 
    ...
    # defining a function called sample for sampling some random n number of transitions 
...
def train(num_episodes, episode_length, learning_rate, scenario = "deathmatch.cfg", map_path = 'map02', render = False):
    ...
    experiences = ExperienceReplay(1500)
